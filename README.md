...
- Ouvrez le fichier `admin.html` en double-cliquant dessus (il s'ouvre dans votre navigateur hors-ligne).
...
Ce projet est optimisé pour **GitHub Pages** (qui est activé dans les Paramètres de ce dépôt).
- Les étudiants accèdent à l'URL racine `https://votre-pseudo.github.io/french-quiz-app/` pour démarrer et choisir n'importe quelle leçon dans le catalogue.
